...
Java Development Kit (JDK) 21 or higher is required for mod development with MC-MultiLoader-MDK.
The compiler for the final build should be set to Java 21.
